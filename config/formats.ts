...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		ruleset: ['Standard 35 Pokes'],
		unbanlist: [
			'Venusaur', 'Charizard', 'Blastoise', 'Butterfree', 'Beedrill', 'Pidgeot', 'Raticate', 'Raticate-Alola', 'Fearow', 'Arbok', 'Raichu', 'Raichu-Alola', 'Sandslash', 'Sandslash-Alola', 'Nidoqueen', 'NidoKing', 'Clefable', 'Ninetales', 'Ninetales-Alola', 'Wigglytuff', 'Vileplume', 'Parasect', 'Venomoth', 'Dugtrio', 'Dugtrio-Alola', 'Persian', 'Persian-Alola', 'Golduck', 'Primeape', 'Arcanine', 'Arcanine-Hisui', 'Poliwrath', 'Alakazam', 'Machamp', 'Victreebel', 'Tentacruel', 'Golem', 'Golem-Alola', 'Rapidash', 'Rapidash-Galar', 'Slowbro', 'Slowbro-Galar', 'Farfetch’d', 'Dodrio', 'Dewgong', 'Muk', 'Muk-Alola', 'Cloyster', 'Gengar', 'Hypno', 'Kingler', 'Electrode', 'Electrode-Hisui', 'Exeggutor', 'Exeggutor-Alola', 'Marowak', 'Marowak-Alola', 'Hitmonlee', 'Hitmonchan', 'Weezing', 'Weezing-Galar', 'Kangaskhan', 'Seaking', 'Starmie', 'Mr. Mime', 'Jynx', 'Pinsir', 'Tauros', 'Tauros-Paldea-Combat', 'Tauros-Paldea-Blaze', 'Tauros-Paldea-Aqua', 'Gyarados', 'Lapras', 'Ditto', 'Vaporeon', 'Jolteon', 'Flareon', 'Omastar', 'Kabutops', 'Aerodactyl', 'Snorlax', 'Meganium', 'Typhlosion', 'Typhlosion-Hisui', 'Feraligatr', 'Furret', 'Noctowl', 'Ledian', 'Ariados', 'Crobat', 'Lanturn', 'Xatu', 'Ampharos', 'Bellossom', 'Azumarill', 'Sudowoodo', 'Politoed', 'Jumpluff', 'Sunflora', 'Quagsire', 'Espeon', 'Umbreon', 'Slowking', 'Slowking-Galar', 'Forretress', 'Steelix', 'Granbull', 'Scizor', 'Shuckle', 'Heracross', 'Magcargo', 'Corsola', 'Corsola-Galar', 'Octillery', 'Delibird', 'Mantine', 'Skarmory', 'Houndoom', 'Kingdra', 'Donphan', 'Smeargle', 'Hitmontop', 'Miltank', 'Blissey', 'Tyranitar', 'Sceptile', 'Swampert', 'Mightyena', 'Linoone', 'Beautifly', 'Dustox', 'Ludicolo', 'Shiftry', 'Swellow', 'Pelipper', 'Gardevoir', 'Masquerain', 'Breloom', 'Slaking', 'Ninjask', 'Shedinja', 'Exploud', 'Hariyama', 'Delcatty', 'Sableye', 'Mawile', 'Aggron', 'Medicham', 'Manectric', 'Plusle', 'Minun', 'Volbeat', 'Illumise', 'Swalot', 'Sharpedo', 'Wailord', 'Camerupt', 'Torkoal', 'Grumpig', 'Spinda', 'Flygon', 'Cacturne', 'Altaria', 'Zangoose', 'Seviper', 'Lunatone', 'Solrock', 'Whiscash', 'Crawdaunt', 'Claydol', 'Cradily', 'Armaldo', 'Milotic', 'Castform', 'Kecleon', 'Banette', 'Tropius', 'Chimecho', 'Absol', 'Glalie', 'Walrein', 'Huntail', 'Gorebyss', 'Relicanth', 'Luvdisc', 'Metagross', 'Torterra', 'Infernape', 'Empoleon', 'Staraptor', 'Bibarel', 'Kricketune', 'Luxray', 'Roserade', 'Rampardos', 'Bastiodon', 'Wormadam-Plant', 'Wormadam-Sandy', 'Wormadam-Trash', 'Mothim', 'Vespiquen', 'Pachirisu', 'Floatzel', 'Cherrim', 'Gastrodon', 'Ambipom', 'Drifblim', 'Lopunny', 'Mismagius', 'Honchkrow', 'Purugly', 'Skuntank', 'Bronzong', 'Chatot', 'Spiritomb', 'Gabite', 'Lucario', 'Hippowdon', 'Drapion', 'Toxicroak', 'Carnivine', 'Lumineon', 'Abomasnow', 'Magnezone', 'Lickilicky', 'Rhyperior', 'Tangrowth', 'Electivire', 'Magmortar', 'Togekiss', 'Yanmega', 'Leafeon', 'Glaceon', 'Mamoswine', 'Porygon-Z', 'Gallade', 'Probopass', 'Dusknoir', 'Froslass', 'Rotom', 'Rotom-Fan', 'Rotom-Frost', 'Rotom-Heat', 'Rotom-Mow', 'Rotom-Wash', 'Serperior', 'Emboar', 'Samurott', 'Watchog', 'Stoutland', 'Liepard', 'Simisage', 'Simisear', 'Simipour', 'Musharna', 'Unfezant', 'Zebstrika', 'Gigalith', 'Swoobat', 'Excadrill', 'Audino', 'Conkeldurr', 'Seismitoad', 'Throh', 'Sawk', 'Leavanny', 'Scolipede', 'Whimsicott', 'Lilligant', 'Lilligant-Hisui', 'Krookodile', 'Darmanitan', 'Maractus', 'Crustle', 'Scrafty', 'Sigilyph', 'Cofagrigus', 'Carracosta', 'Archeops', 'Garbodor', 'Zoroark', 'Zoroark-Hisui', 'Cinccino', 'Gothitelle', 'Reuniclus', 'Swanna', 'Vanilluxe', 'Sawsbuck', 'Emolga', 'Escavalier', 'Amoonguss', 'Jellicent', 'Alomomola', 'Galvantula', 'Ferrothorn', 'Klinklang', 'Eelektross', 'Beheeyem', 'Chandelure', 'Haxorus', 'Beartic', 'Cryogonal', 'Accelgor', 'Stunfisk', 'Stunfisk-Galar', 'Mienshao', 'Druddigon', 'Golurk', 'Bouffalant', 'Braviary', 'Braviary-Hisui', 'Mandibuzz', 'Heatmor', 'Durant', 'Chesnaught', 'Delphox', 'Diggersby', 'Talonflame', 'Vivillon', 'Pyroar', 'Florges', 'Gogoat', 'Pangoro', 'Furfrou', 'Meowstic', 'Aromatisse', 'Slurpuff', 'Malamar', 'Barbaracle', 'Dragalge', 'Clawitzer', 'Heliolisk', 'Tyrantrum', 'Aurorus', 'Sylveon', 'Hawlucha', 'Dedenne', 'Carbink', 'Goodra', 'Goodra-Hisui', 'Klefki', 'Trevenant', 'Gourgeist-Small', 'Gourgeist-Average', 'Gourgeist-Large', 'Gourgeist-Super', 'Avalugg', 'Avalugg-Hisui', 'Noivern', 'Decidueye', 'Decidueye-Hisui', 'Incineroar', 'Primarina', 'Toucannon', 'Gumshoos', 'Vikavolt', 'Crabominable', 'Oricorio-Baile', 'Oricorio-Pom-Pom', 'Oricorio-Pa\'u', 'Oricorio-Sensu', 'Ribombee', 'Lycanroc-Midday', 'Lycanroc-Midnight', 'Lycanroc-Dusk', 'Wishiwashi', 'Mudsdale', 'Araquanid', 'Lurantis', 'Shiinotic', 'Salazzle', 'Bewear', 'Tsareena', 'Comfey', 'Oranguru', 'Passimian', 'Golisopod', 'Palossand', 'Pyukumuku', 'Silvally', 'Silvally-Bug', 'Silvally-Dark', 'Silvally-Dragon', 'Silvally-Electric', 'Silvally-Fairy', 'Silvally-Fighting', 'Silvally-Fire', 'Silvally-Flying', 'Silvally-Ghost', 'Silvally-Grass', 'Silvally-Ground', 'Silvally-Ice', 'Silvally-Poison', 'Silvally-Psychic', 'Silvally-Rock', 'Silvally-Steel', 'Silvally-Water', 'Minior', 'Komala', 'Turtonator', 'Togedemaru', 'Mimikyu', 'Bruxish', 'Drampa', 'Dhelmise', 'Inteleon', 'Greedent', 'Corviknight', 'Orbeetle', 'Thievul', 'Eldegoss', 'Dubwool', 'Drednaw', 'Boltund', 'Coalossal', 'Flapple', 'Appletun', 'Sandaconda', 'Cramorant', 'Barraskewda', 'Toxtricity-Amped', 'Toxtricity-Lowkey', 'Centiskorch', 'Grapploct', 'Polteageist', 'Hatterene', 'Grimmsnarl', 'Obstagoon', 'Perrserker', 'Cursola', 'Sirfetch’d', 'Mr. Rime', 'Runerigus', 'Alcremie', 'Falinks', 'Pincurchin', 'Frosmoth', 'Stonjourner', 'Eiscue', 'Indeedee-M', 'Indeedee-F', 'Morpeko', 'Copperajah', 'Dracozolt', 'Arctozolt', 'Arctovish', 'Duraludon', 'Wyrdeer', 'Kleavor', 'Overqwil', 'Skeledirge', 'Quaquaval', 'Oinkologne-M', 'Oinkologne-F', 'Spidops', 'Lokix', 'Pawmot', 'Maushold', 'Dachsbun', 'Arboliva', 'Squawkabilly', 'Garganacl', 'Armarouge', 'Ceruledge', 'Bellibolt', 'Kilowattrel', 'Mabosstiff', 'Grafaiai', 'Brambleghast', 'Toedscruel', 'Klawf', 'Scovillain', 'Rabsca', 'Tinkaton', 'Wugtrio', 'Bombirdier', 'Revavroom', 'Cyclizar', 'Orthworm', 'Glimmora', 'Houndstone', 'Flamigo', 'Cetitan', 'Veluza', 'Dondozo', 'Tatsugiri', 'Clodsire', 'Farigiraf', 'Dudunsparce', 'Dipplin', 'Sinistcha', 'Scyther', 'Dusclops', 'Bisharp', 'Vigoroth', 'Dragonair', 'Shelgon', 'Arctibax', 'Porygon2', 'Rhydon', 'Qwilfish', 'Doublade', 'Drakloak', 'Trapinch', 'Okidogi', 'Munkidori', 'Fezandipiti', 'Regirock', 'Regice', 'Registeel', 'Articuno', 'Articuno-Galar', 'Moltres', 'Phione', 'Mesprit', 'Basculin-R', 'Basculin-B', 'Basculin-W', 'Basculegion-M', 'Basculegion-F', 'Diancie', 'Entei', 'Stakataka', 'Wo-Chien', 'Cobalion', 'Virizion', 'Shaymin', 'Celebi', 'Zygarde-10%', 'Guzzlord', 'Brute Bonnet', 'Iron Thorns', 'Hydrapple', 'Sneasel-Hisui', 'Zweilous', 'Calyrex', 'Regigigas', 'Uxie', 'Type-Null', 'Pupitar', 'Regieleki', 'Sneasel', 'Thwackey',
		],
		validateTeam(team, options) {
			return ['Not Implemented'];
		},
