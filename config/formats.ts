...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		ruleset: ['Standard 35 Pokes'],
		unbanlist: [
			'Abomasnow-Base', 'Absol-Base', 'Accelgor', 'Aerodactyl-Base', 'Aggron-Base', 'Alakazam-Base', 'Alcremie', 'Alomomola', 'Altaria-Base', 'Ambipom', 'Amoonguss', 'Ampharos-Base', 'Appletun', 'Araquanid-Base', 'Arbok', 'Arboliva', 'Arcanine-Base', 'Arcanine-Hisui', 'Archeops', 'Arctibax', 'Arctovish', 'Arctozolt', 'Ariados', 'Armaldo', 'Armarouge', 'Aromatisse', 'Articuno-Base', 'Articuno-Galar', 'Audino-Base', 'Aurorus', 'Avalugg-Base', 'Avalugg-Hisui', 'Azumarill', 'Banette-Base', 'Barbaracle', 'Barraskewda', 'Basculegion-Base', 'Basculegion-F', 'Basculin-Base', 'Basculin-Blue-Striped', 'Basculin-White-Striped', 'Bastiodon', 'Beartic', 'Beautifly', 'Beedrill-Base', 'Beheeyem', 'Bellibolt', 'Bellossom', 'Bewear', 'Bibarel', 'Bisharp', 'Blastoise-Base', 'Blissey', 'Boltund', 'Bombirdier', 'Bouffalant', 'Brambleghast', 'Braviary-Base', 'Braviary-Hisui', 'Breloom', 'Bronzong', 'Brute Bonnet', 'Bruxish', 'Butterfree', 'Cacturne', 'Calyrex-Base', 'Camerupt-Base', 'Carbink', 'Carnivine', 'Carracosta', 'Castform-Base', 'Celebi', 'Centiskorch', 'Ceruledge', 'Cetitan', 'Chandelure', 'Charizard-Base', 'Chatot', 'Cherrim-Base', 'Chesnaught', 'Chimecho', 'Cinccino', 'Clawitzer', 'Claydol', 'Clefable', 'Clodsire', 'Cloyster', 'Coalossal', 'Cobalion', 'Cofagrigus', 'Comfey', 'Conkeldurr', 'Copperajah', 'Corsola-Base', 'Corsola-Galar', 'Corviknight', 'Crabominable', 'Cradily', 'Cramorant-Base', 'Crawdaunt', 'Crobat', 'Crustle', 'Cryogonal', 'Cursola', 'Cyclizar', 'Dachsbun', 'Darmanitan-Base', 'Decidueye-Base', 'Decidueye-Hisui', 'Dedenne', 'Delcatty', 'Delibird', 'Delphox', 'Dewgong', 'Dhelmise', 'Diancie-Base', 'Diggersby', 'Dipplin', 'Ditto', 'Dodrio', 'Dondozo', 'Donphan', 'Doublade', 'Dracozolt', 'Dragalge', 'Dragonair', 'Drakloak', 'Drampa', 'Drapion', 'Drednaw', 'Drifblim', 'Druddigon', 'Dubwool', 'Dudunsparce', 'Dugtrio-Alola', 'Dugtrio-Base', 'Duraludon', 'Durant', 'Dusclops', 'Dusknoir', 'Dustox', 'Eelektross', 'Eiscue-Base', 'Eldegoss', 'Electivire', 'Electrode-Base', 'Electrode-Hisui', 'Emboar', 'Emolga', 'Empoleon', 'Entei', 'Escavalier', 'Espeon', 'Excadrill', 'Exeggutor-Alola', 'Exeggutor-Base', 'Exploud', 'Falinks', 'Farfetch’d-Base', 'Farigiraf', 'Fearow', 'Feraligatr', 'Ferrothorn', 'Fezandipiti', 'Flamigo', 'Flapple', 'Flareon', 'Floatzel', 'Florges', 'Flygon', 'Forretress', 'Froslass', 'Frosmoth', 'Furfrou', 'Furret', 'Gabite', 'Gallade-Base', 'Galvantula', 'Garbodor', 'Gardevoir-Base', 'Garganacl', 'Gastrodon', 'Gengar-Base', 'Gigalith', 'Glaceon', 'Glalie-Base', 'Glimmora', 'Gogoat', 'Golduck', 'Golem-Alola', 'Golem-Base', 'Golisopod', 'Golurk', 'Goodra-Base', 'Goodra-Hisui', 'Gorebyss', 'Gothitelle', 'Gourgeist-Base', 'Gourgeist-Large', 'Gourgeist-Small', 'Gourgeist-Super', 'Grafaiai', 'Granbull', 'Grapploct', 'Greedent', 'Grimmsnarl', 'Grumpig', 'Gumshoos-Base', 'Guzzlord', 'Gyarados-Base', 'Hariyama', 'Hatterene', 'Hawlucha', 'Haxorus', 'Heatmor', 'Heliolisk', 'Heracross-Base', 'Hippowdon', 'Hitmonchan', 'Hitmonlee', 'Hitmontop', 'Honchkrow', 'Houndoom-Base', 'Houndstone', 'Huntail', 'Hydrapple', 'Hypno', 'Illumise', 'Incineroar', 'Indeedee-Base', 'Indeedee-F', 'Infernape', 'Inteleon', 'Iron Thorns', 'Jellicent', 'Jolteon', 'Jumpluff', 'Jynx', 'Kabutops', 'Kangaskhan-Base', 'Kecleon', 'Kilowattrel', 'Kingdra', 'Kingler', 'Klawf', 'Kleavor', 'Klefki', 'Klinklang', 'Komala', 'Kricketune', 'Krookodile', 'Lanturn', 'Lapras', 'Leafeon', 'Leavanny', 'Ledian', 'Lickilicky', 'Liepard', 'Lilligant-Base', 'Lilligant-Hisui', 'Linoone-Base', 'Lokix', 'Lopunny-Base', 'Lucario-Base', 'Ludicolo', 'Lumineon', 'Lunatone', 'Lurantis-Base', 'Luvdisc', 'Luxray', 'Lycanroc-Base', 'Lycanroc-Dusk', 'Lycanroc-Midnight', 'Mabosstiff', 'Machamp', 'Magcargo', 'Magmortar', 'Magnezone', 'Malamar', 'Mamoswine', 'Mandibuzz', 'Manectric-Base', 'Mantine', 'Maractus', 'Marowak-Alola', 'Marowak-Base', 'Masquerain', 'Maushold', 'Mawile-Base', 'Medicham-Base', 'Meganium', 'Meowstic', 'Mesprit', 'Metagross-Base', 'Mienshao', 'Mightyena', 'Milotic', 'Miltank', 'Mimikyu-Base', 'Minior-Base', 'Minun', 'Mismagius', 'Moltres-Base', 'Morpeko-Base', 'Mothim', 'Mr. Mime-Base', 'Mr. Rime', 'Mudsdale', 'Muk-Alola', 'Muk-Base', 'Munkidori', 'Musharna', 'Nidoking', 'Nidoqueen', 'Ninetales-Alola', 'Ninetales-Base', 'Ninjask', 'Noctowl', 'Noivern', 'Obstagoon', 'Octillery', 'Oinkologne-Base', 'Oinkologne-F', 'Okidogi', 'Omastar', 'Oranguru', 'Orbeetle', 'Oricorio-Base', 'Oricorio-Pa\'u', 'Oricorio-Pom-Pom', 'Oricorio-Sensu', 'Orthworm', 'Overqwil', 'Pachirisu', 'Palossand', 'Pangoro', 'Parasect', 'Passimian', 'Pawmot', 'Pelipper', 'Perrserker', 'Persian-Alola', 'Persian-Base', 'Phione', 'Pidgeot-Base', 'Pincurchin', 'Pinsir-Base', 'Plusle', 'Politoed', 'Poliwrath', 'Polteageist', 'Porygon-Z', 'Porygon2', 'Primarina', 'Primeape', 'Probopass', 'Pupitar', 'Purugly', 'Pyroar', 'Pyukumuku', 'Quagsire', 'Quaquaval', 'Qwilfish-Base', 'Rabsca', 'Raichu-Alola', 'Raichu-Base', 'Rampardos', 'Rapidash-Base', 'Rapidash-Galar', 'Raticate-Alola', 'Raticate-Base', 'Regice', 'Regieleki', 'Regigigas', 'Regirock', 'Registeel', 'Relicanth', 'Reuniclus', 'Revavroom', 'Rhydon', 'Rhyperior', 'Ribombee-Base', 'Roserade', 'Rotom-Base', 'Rotom-Fan', 'Rotom-Frost', 'Rotom-Heat', 'Rotom-Mow', 'Rotom-Wash', 'Runerigus', 'Sableye-Base', 'Salazzle-Base', 'Samurott-Base', 'Sandaconda', 'Sandslash-Alola', 'Sandslash-Base', 'Sawk', 'Sawsbuck', 'Sceptile-Base', 'Scizor-Base', 'Scolipede', 'Scovillain', 'Scrafty', 'Scyther', 'Seaking', 'Seismitoad', 'Serperior', 'Seviper', 'Sharpedo-Base', 'Shaymin-Base', 'Shedinja', 'Shelgon', 'Shiftry', 'Shiinotic', 'Shuckle', 'Sigilyph', 'Silvally', 'Silvally-Bug', 'Silvally-Dark', 'Silvally-Dragon', 'Silvally-Electric', 'Silvally-Fairy', 'Silvally-Fighting', 'Silvally-Fire', 'Silvally-Flying', 'Silvally-Ghost', 'Silvally-Grass', 'Silvally-Ground', 'Silvally-Ice', 'Silvally-Poison', 'Silvally-Psychic', 'Silvally-Rock', 'Silvally-Steel', 'Silvally-Water', 'Simipour', 'Simisage', 'Simisear', 'Sinistcha', 'Sirfetch’d', 'Skarmory', 'Skeledirge', 'Skuntank', 'Slaking', 'Slowbro-Base', 'Slowbro-Galar', 'Slowking-Base', 'Slowking-Galar', 'Slurpuff', 'Smeargle', 'Sneasel-Base', 'Sneasel-Hisui', 'Snorlax', 'Solrock', 'Spidops', 'Spinda', 'Spiritomb', 'Squawkabilly', 'Stakataka', 'Staraptor', 'Starmie', 'Steelix-Base', 'Stonjourner', 'Stoutland', 'Stunfisk-Base', 'Stunfisk-Galar', 'Sudowoodo', 'Sunflora', 'Swalot', 'Swampert-Base', 'Swanna', 'Swellow', 'Swoobat', 'Sylveon', 'Talonflame', 'Tangrowth', 'Tatsugiri', 'Tauros-Base', 'Tauros-Paldea-Aqua', 'Tauros-Paldea-Blaze', 'Tauros-Paldea-Combat', 'Tentacruel', 'Thievul', 'Throh', 'Thwackey', 'Tinkaton', 'Toedscruel', 'Togedemaru-Base', 'Togekiss', 'Torkoal', 'Torterra', 'Toucannon', 'Toxicroak', 'Toxtricity-Base', 'Toxtricity-Low-Key', 'Trapinch', 'Trevenant', 'Tropius', 'Tsareena', 'Turtonator', 'Type: Null', 'Typhlosion-Base', 'Typhlosion-Hisui', 'Tyranitar-Base', 'Tyrantrum', 'Umbreon', 'Unfezant', 'Uxie', 'Vanilluxe', 'Vaporeon', 'Veluza', 'Venomoth', 'Venusaur-Base', 'Vespiquen', 'Victreebel', 'Vigoroth', 'Vikavolt-Base', 'Vileplume', 'Virizion', 'Vivillon', 'Volbeat', 'Wailord', 'Walrein', 'Watchog', 'Weezing-Base', 'Weezing-Galar', 'Whimsicott', 'Whiscash', 'Wigglytuff', 'Wishiwashi-Base', 'Wo-Chien', 'Wormadam-Base', 'Wormadam-Sandy', 'Wormadam-Trash', 'Wugtrio', 'Wyrdeer', 'Xatu', 'Yanmega', 'Zangoose', 'Zebstrika', 'Zoroark-Base', 'Zoroark-Hisui', 'Zweilous', 'Zygarde-10%',
		],
		validateTeam(team, options) {
			return ['Not Implemented'];
		},
