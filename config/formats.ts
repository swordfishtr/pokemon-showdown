...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		ruleset: [
			...
			'!Evasion Abilities Clause', 'Evasion Abilities Extended Clause', 'Accuracy Clause Mod', 'NatDex Mod',

			'#butterfreeg +bugbite +bugbuzz +confusion +cosmicpower +curse +darkpulse +dazzlinggleam +defog +destinybond +disable +eerieimpulse +eeriespell +electroweb +endure +expandingforce +facade +futuresight +gigadrain +gigaimpact +harden +haze +hex +hurricane +hyperbeam +hypnosis +icywind +imprison +infestation +irondefense +knockoff +megadrain +memento +moonblast +moonlight +nastyplot +nightdaze +nightshade +painsplit +pollenpuff +protect +psybeam +psychicfangs +psychup +psyshock +quiverdance +ragepowder +rest +scaryface +shadowball +sleeptalk +sludgewave +spite +storedpower +strengthsap +stringshot +strugglebug +substitute +superfang +tackle +taunt +thief +trick +trickroom',

			'#beedrillg +agility +assurance +breakingswipe +brickbreak +bugbite +bulldoze +dig +doubleedge +drillrun +earthpower +earthquake +electroweb +endeavor +endure +facade +falseswipe +feint +fellstinger +firstimpression +flashcannon +focusenergy +furyattack +gigaimpact +harden +hyperbeam +irondefense +knockoff +lashout +lunge +metalclaw +metalsound +mudshot +mudslap +pinmissile +poisonjab +poisonsting +protect +quickguard +rapidspin +rest +rockblast +rockslide +rocktomb +sandstorm +sandtomb +scorchingsands +sleeptalk +smartstrike +spikes +stealthrock +stompingtantrum +stoneaxe +stoneedge +stringshot +strugglebug +substitute +takedown +thief +trailblaze +twineedle +xscissor',

			'#usurperr +aerialace +amnesia +batonpass +bodyslam +brickbreak +charm +chillingwater +closecombat +covet +crunch +curse +darkestlariat +darkpulse +dig +doubleedge +endeavor +endure +fakeout +faketears +falseswipe +flail +flashcannon +fling +foulplay +furyswipes +gigaimpact +growl +gunkshot +gyroball +heavyslam +helpinghand +honeclaws +hyperbeam +hypervoice +irondefense +ironhead +knockoff +lashout +metalburst +metalclaw +metalsound +move:metronome +nastyplot +nightslash +outrage +payday +playrough +protect +raindance +rest +scratch +screech +seedbomb +shadowball +shadowclaw +slash +sleeptalk +spite +stealthrock +steelbeam +substitute +sunnyday +supercellslam +swagger +swordsdance +takedown +taunt +thief +thrash +throatchop +thunder +thunderbolt +trailblaze +upperhand +uturn +xscissor',

			'#valkaryia +alluringvoice +avalanche +blizzard +bodyslam +brickbreak +calmmind +charm +chillingwater +closecombat +confusion +copycat +covet +curse +disarmingvoice +doubleedge +drainingkiss +drainpunch +dualchop +earthquake +echoedvoice +encore +endure +expandingforce +facade +fakeout +faketears +fling +focusblast +focuspunch +followme +futuresight +gigaimpact +grassknot +helpinghand +hydropump +hyperbeam +hypervoice +icebeam +icepunch +icespinner +iciclespear +icywind +lick +lightscreen +lovelykiss +meanlook +move:metronome +nastyplot +perishsong +pound +powdersnow +powergem +protect +psychic +psychicnoise +psychicterrain +psychup +psyshock +raindance +reflect +rest +roleplay +shadowball +skillswap +sleeptalk +snowscape +stompingtantrum +storedpower +substitute +sweetkiss +takedown +taunt +teleport +terablast +thief +trick +trickroom +tripleaxel +uproar +wish +zenheadbutt',

			'#irongoro +beatup +bodyslam +brickbreak +burningjealousy +charge +closecombat +crunch +darkpulse +dig +doubleedge +electricterrain +electroball +encore +endure +facade +fakeout +finalgambit +fireblast +firefang +flamethrower +flashcannon +fling +fly +focusblast +followme +gigaimpact +helpinghand +hornattack +hyperbeam +irondefense +irontail +jawlock +knockoff +lashout +lightscreen +megahorn +memento +metalsound +nastyplot +nuzzle +outrage +overheat +playrough +protect +psychicfangs +rest +reversal +roar +sandstorm +scaryface +sleeptalk +snarl +stompingtantrum +substitute +sunnyday +supercellslam +superfang +surf +tailwhip +takedown +taunt +temperflare +thief +throatchop +thunder +thunderbolt +thunderfang +thunderwave +uproar +voltswitch +volttackle',

			'#ironsoke +acrobatics +agility +aurasphere +batonpass +breakingswipe +brickbreak +calmmind +chargebeam +closecombat +coaching +detect +dig +electricterrain +electroweb +endure +energyball +expandingforce +facade +fakeout +feint +firepunch +flamecharge +flashcannon +focusblast +focusenergy +focuspunch +futuresight +gigaimpact +gyroball +helpinghand +hyperbeam +icebeam +icepunch +icespinner +instruct +ironhead +lowkick +lowsweep +lunge +meteorbeam +move:metronome +protect +psybeam +psychic +psyshock +quickguard +raindance +rapidspin +reflect +rest +reversal +sleeptalk +smackdown +smartstrike +solarbeam +spinout +steelbeam +strugglebug +substitute +sunnyday +swift +takedown +taunt +thief +thunderpunch +tripleaxel +triplekick +upperhand +voltswitch +wideguard +zenheadbutt',

			'#trembler +acidarmor +agility +amnesia +astonish +aurasphere +bubblebeam +chillingwater +chillyreception +crabhammer +curse +defog +dig +endure +energyball +faketears +falseswipe +flail +flashcannon +gigaimpact +growl +guillotine +harden +haze +healpulse +hex +hyperbeam +hypervoice +icywind +imprison +leechlife +lightscreen +liquidation +lowkick +metalclaw +metalsound +mirrorcoat +muddywater +mudshot +mudslap +nightshade +painsplit +perishsong +phantomforce +pounce +protect +psychicnoise +quickguard +raindance +razorshell +reflecttype +rest +roar +sandattack +scorchingsands +shadowball +shadowclaw +shadowsneak +shoreup +skillswap +skittersmack +sleeptalk +sludgewave +snaptrap +snarl +storedpower +substitute +sunnyday +surf +swift +switcheroo +terrainpulse +thief +trailblaze +trickroom +visegrip +watergun +whirlpool +willowisp +xscissor',
		],
		banlist: [
	...
	},
	{
		...
		ruleset: [
			...
			'#charizard -scorchingsands',
			'#sandslashalola +coldsnap',
			'#ninetalesalola +coldsnap',
			'#kingdra +snipeshot',
			'#annihilape +dualchop',
			'#screamtail +coldsnap',

			'#pidgeot -splash +aerialace +agility +aircutter +airslash +bodyslam +bravebird +defog +doubleedge +dualwingbeat +facade +featherdance +finalgambit +fly +focusblast +gigaimpact +gust +heatwave +hurricane +hyperbeam +hypervoice +mudslap +protect +quickattack +raindance +reflect +rest +roost +sandattack +sleeptalk +snarl +steelwing +substitute +sunnyday +swift +tackle +tailwind +takedown +thief +throatchop +trailblaze +twister +uproar +uturn +whirlwind +wingattack',

			'#alakazam -splash +bodyslam +calmmind +chargebeam +coldsnap +confusion +dazzlinggleam +disable +drainpunch +encore +endure +energyball +expandingforce +facade +firepunch +flashcannon +fling +focusblast +focuspunch +foulplay +futuresight +gigaimpact +grassknot +hyperbeam +hypervoice +icepunch +imprison +knockoff +lightscreen +move:metronome +nastyplot +nightshade +protect +psybeam +psychic +psychicnoise +psychicterrain +psychocut +psychup +psyshock +raindance +recover +reflect +rest +roleplay +shadowball +skillswap +sleeptalk +storedpower +substitute +sunnyday +swift +taunt +teleport +thief +thunderpunch +thunderwave +trick +trickroom +zenheadbutt',

			'#machamp -splash +bodyslam +brickbreak +bulkup +bulldoze +bulletpunch +closecombat +counter +crosschop +curse +dig +doubleedge +dualchop +dynamicpunch +earthquake +encore +endure +facade +fireblast +firepunch +flamethrower +fling +focusblast +focusenergy +focuspunch +gigaimpact +heavyslam +helpinghand +highhorsepower +hyperbeam +icepunch +knockoff +leer +lightscreen +lowkick +lowsweep +move:metronome +payback +poisonjab +protect +quickguard +raindance +rest +reversal +rockblast +rockslide +rocktomb +scaryface +seismictoss +sleeptalk +smackdown +stompingtantrum +stoneedge +strength +substitute +sunnyday +superpower +takedown +thief +throatchop +thunderpunch +tickle +vacuumwave +wideguard',

			'#pinsir -splash +bind +bodyslam +brickbreak +bugbite +bulkup +bulldoze +ceaselessedge +circlethrow +closecombat +dig +doublehit +earthquake +endure +facade +falseswipe +feint +flail +fling +focusblast +focusenergy +focuspunch +furyattack +furycutter +gigaimpact +guillotine +harden +helpinghand +highhorsepower +hyperbeam +irondefense +lashout +megahorn +outrage +protect +quickattack +raindance +rest +reversal +rockslide +rocktomb +seismictoss +sleeptalk +smackdown +stealthrock +stoneedge +strength +strugglebug +substitute +sunnyday +superpower +swordsdance +takedown +thief +thrash +throatchop +trailblaze +vicegrip +xscissor',

			'#aerodactyl -splash +aerialace +agility +aircutter +ancientpower +bite +bulldoze +crunch +curse +doubleedge +dragonbreath +dragonclaw +dragondance +dragonpulse +dualwingbeat +earthpower +earthquake +endure +facade +fireblast +firefang +flamethrower +fly +gigaimpact +heatwave +hurricane +hyperbeam +icefang +ironhead +meteorbeam +outrage +protect +psychicfangs +raindance +rest +roar +rockblast +rockpolish +rockslide +rocktomb +sandstorm +scaleshot +scaryface +skyattack +sleeptalk +smackdown +stealthrock +steelwing +stompingtantrum +stoneedge +substitute +sunnyday +swift +tailwind +takedown +taunt +temperflare +thief +thunderfang +whirlwind +wideguard +wingattack',

			'#tangrowth -splash +absorb +amnesia +ancientpower +bind +block +bodyslam +breakingswipe +brickbreak +bulldoze +bulletseed +confusion +drainpunch +earthquake +endeavor +endure +energyball +facade +flail +fling +focusblast +focuspunch +gigadrain +gigaimpact +grassknot +grassyglide +grassyterrain +growth +hardpress +hyperbeam +infestation +ingrain +knockoff +leafstorm +leechseed +megadrain +painsplit +payback +poisonjab +poisonpowder +powerwhip +protect +ragepowder +reflect +rest +rockslide +rocktomb +seedbomb +slam +sleeppowder +sleeptalk +sludgebomb +solarbeam +solarblade +stompingtantrum +stunspore +substitute +sunnyday +swordsdance +synthesis +thief +tickle +upperhand +vinewhip',

			'#butterfreeg +bugbite +bugbuzz +coldsnap +confusion +cosmicpower +curse +darkpulse +dazzlinggleam +defog +destinybond +disable +eerieimpulse +eeriespell +electroweb +endure +expandingforce +facade +futuresight +gigadrain +gigaimpact +harden +haze +hex +hurricane +hyperbeam +hypnosis +icywind +imprison +infestation +irondefense +knockoff +megadrain +memento +moonblast +moonlight +nastyplot +nightdaze +nightshade +painsplit +pollenpuff +protect +psybeam +psychicfangs +psychup +psyshock +quiverdance +ragepowder +rest +scaryface +shadowball +sleeptalk +sludgewave +spite +storedpower +strengthsap +stringshot +strugglebug +substitute +superfang +tackle +taunt +thief +trick +trickroom',

			'#beedrillg +agility +assurance +breakingswipe +brickbreak +bugbite +bulldoze +dig +doubleedge +drillrun +earthpower +earthquake +electroweb +endeavor +endure +facade +falseswipe +feint +fellstinger +firstimpression +flashcannon +focusenergy +furyattack +gigaimpact +harden +hyperbeam +irondefense +knockoff +lashout +lunge +metalclaw +metalsound +mudshot +mudslap +pinmissile +poisonjab +poisonsting +protect +quickguard +rapidspin +rest +rockblast +rockslide +rocktomb +sandstorm +sandtomb +scorchingsands +sleeptalk +smartstrike +spikes +stealthrock +stompingtantrum +stoneaxe +stoneedge +stringshot +strugglebug +substitute +takedown +thief +trailblaze +twineedle +xscissor',

			'#usurperr +aerialace +amnesia +batonpass +bodyslam +brickbreak +charm +chillingwater +closecombat +covet +crunch +curse +darkestlariat +darkpulse +dig +doubleedge +endeavor +endure +fakeout +faketears +falseswipe +flail +flashcannon +fling +foulplay +furyswipes +gigaimpact +growl +gunkshot +gyroball +heavyslam +helpinghand +honeclaws +hyperbeam +hypervoice +irondefense +ironhead +knockoff +lashout +metalburst +metalclaw +metalsound +move:metronome +nastyplot +nightslash +outrage +payday +playrough +protect +raindance +rest +scratch +screech +seedbomb +shadowball +shadowclaw +slash +sleeptalk +spite +stealthrock +steelbeam +substitute +sunnyday +supercellslam +swagger +swordsdance +takedown +taunt +thief +thrash +throatchop +thunder +thunderbolt +trailblaze +upperhand +uturn +xscissor',

			'#valkaryia +alluringvoice +avalanche +blizzard +bodyslam +brickbreak +calmmind +charm +chillingwater +closecombat +coldsnap +confusion +copycat +covet +curse +disarmingvoice +doubleedge +drainingkiss +drainpunch +dualchop +earthquake +echoedvoice +encore +endure +expandingforce +facade +fakeout +faketears +fling +focusblast +focuspunch +followme +futuresight +gigaimpact +grassknot +helpinghand +hydropump +hyperbeam +hypervoice +icebeam +icepunch +icespinner +iciclespear +icywind +lick +lightscreen +lovelykiss +meanlook +move:metronome +nastyplot +perishsong +pound +powdersnow +powergem +protect +psychic +psychicnoise +psychicterrain +psychup +psyshock +raindance +reflect +rest +roleplay +shadowball +skillswap +sleeptalk +snowscape +stompingtantrum +storedpower +substitute +sweetkiss +takedown +taunt +teleport +terablast +thief +trick +trickroom +tripleaxel +uproar +wish +zenheadbutt',
	...
	},
	{
		...
		ruleset: ['Standard 35 Pokes',
					...
					'#gible+eartheater',
					'#varoom+motordrive+noxioustorque',
		...
		unbanlist: [
			'Booster Energy',
			'Parasect', 'Corsola', 'Castform', 'Stunfisk-Galar', 'Delibird', 'Ducklett', 'Finneon', 'Cubchoo', 'Larvesta', 'Skrelp', 'Jigglypuff', 'Golett', 'Togepi', 'Dreepy', 'Wooper-Paldea', 'Gible', 'Varoom', 'Geodude-Alola', 'Sandile', 'Gimmighoul', 'Rowlet', 'Litten', 'Magnemite', 'Croagunk', 'Smoochum', 'Chespin', 'Pawmo', 'Pineco', 'Baltoy', 'Corvisquire', 'Ferroseed', 'Scraggy', 'Litleo', 'Marill', 'Munna',
		],
	},
