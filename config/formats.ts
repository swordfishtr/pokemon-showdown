...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		ruleset: [
			...
			'#Angelpuss +afteryou +alluringvoice +allyswitch +amnesia +aromaticmist +assist +attract +babydolleyes +batonpass +bide +bodyslam +calmmind +captivate +charm +confide +copycat +covet +craftyshield +curse +dazzlinggleam +disarmingvoice +doubleedge +drainingkiss +facade +fairywind +flash +frustration +headbutt +healbell +healpulse +healingwish +hiddenpower +hypervoice +icywind +imprison +lastresort +lovelykiss +luckychant +magiccoat +metronome +mimic +mirrorcoat +moonblast +moonlight +morningsun +naturalgift +naturepower +painsplit +playnice +protect +recover +reflect +refresh +rest +return +round +simplebeam +skillswap +sleeptalk +substitute +sweetkiss +teleport +toxic +trick +wish',
