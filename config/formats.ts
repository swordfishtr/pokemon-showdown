...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		ruleset: [
			...
			'#lumineon+drizzle',
			'#granbull+slushrush+drainpunch',
			'#delibird+snowwarning+beakblast+roost',
